...
// var minersAddr = '0x70Fe0330bb39a7A790E4c34055a2a3512688265B';
// var tokenAddr = '0x5ed0e97a2bf7b4820469f4d892b96684b5c13d17';
...
function buyEggs(ref, trx, callback){
	if(+trx/1e9 > +usrBal*1e9) {
		alert("You don't have " + trx/1e9 + " PulseFeg in your wallet");
		console.log('test')
		console.log(trx)
		console.log(usrBal)
		console.log(spend)
	}
	else if(+trx/1e9 > +spend*1e9) {
		alert("Approve spending " + trx/1e9 + " PulseFeg first");
		console.log('test')
		console.log(trx)
		console.log(usrBal)
		console.log(spend*1e9)
	} else {
		var spendToken=web3.utils.toWei(trx)/1e9
			minersContract.methods.buyEggs(ref, spendToken.toString()).send({ from:currentAddr }).then(result => {
        callback();
    }).catch((err) => {
        console.log(err)
    });
